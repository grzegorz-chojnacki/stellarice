...
const civicsNormal = {
  ...
  DistinguishedAdmiralty: new Civic(() => some(
    ethics.Militarist, ethics.FanaticMilitarist
  )),
  ExaltedPriesthood:      new Civic(() => every(
  ...
  PhilosopherKing:        new Civic(() => some(
    authority.Dictatorial,
    authority.Imperial,
  )),
  PoliceState:            new Civic(() => none(
    ethics.FanaticEgalitarian
  )),
  ShadowCouncil:          new Civic(() => none(
    authority.Imperial,
  )),
  SlaverGuilds:           new Civic(() => every(
    some(ethics.Authoritarian, ethics.FanaticAuthoritarian),
    none(civics.PleasureSeekers),
  )),
  Technocracy:            new Civic(() => every(
  ...
  WarriorCulture:         new Civic(() => every(
    some(ethics.Militarist, ethics.FanaticMilitarist),
  )),
  CatalyticProcessing:    new Civic(() => none(
    origin.CalamitousBirth,
  )),
  IdyllicBloom:           new Civic(() => every(
    pop.Botanic,
    none(origin.VoidDwellers),
  )),
  FanaticPurifiers:       new Civic(() => every(
  ...
  PleasureSeekers:        new Civic(() => none(
    civics.SlaverGuilds,
    civics.WarriorCulture,
    civics.SharedBurdens,
  )),
  PompousPurists:         new Civic(() => every(
    some(ethics.Xenophobe, ethics.FanaticXenophobe),
    none(
  ...
  BarbaricDespoilers:     new Civic(() => every(
    some(ethics.Militarist, ethics.Spiritualist),
    some(
      ethics.Authoritarian, ethics.FanaticAuthoritarian,
  ...
  ByzantineBureaucracy:   new Civic(() => none(
    ethics.Spiritualist, ethics.FanaticSpiritualist,
  )),
  MerchantGuilds:         new Civic(() => none(
    civics.ExaltedPriesthood,
    civics.AristocraticElite,
    civics.Technocracy,
  )),
  SharedBurdens:          new Civic(() => every(
    ethics.FanaticEgalitarian,
    none(
      ethics.Xenophobe, ethics.FanaticXenophobe,
      civics.Technocracy,
  ...
  DiplomaticCorps:        new Civic(() => none(
    civics.InwardPerfection,
    civics.FanaticPurifiers,
  )),
  Memorialists:           new Civic(() => none(
    civics.FanaticPurifiers,
  )),
  Reanimators:            new Civic(() => none(
    ethics.Pacifist, ethics.FanaticPacifist,
    civics.CitizenService,
  )),
  DeathCult:              new Civic(() => every(
    some(ethics.Spiritualist, ethics.FanaticSpiritualist),
    none(
      civics.InwardPerfection,
      civics.FanaticPurifiers,
...
const civicsCorporate = {
  ...
  BrandLoyalty:               new Civic(() => none(
    civics.BeaconOfLiberty,
  )),
  GospelOfTheMasses:          new Civic(() => every(
    some(ethics.Spiritualist, ethics.FanaticSpiritualist),
  )),
  IndenturedAssets:           new Civic(() => every(
    some(ethics.Authoritarian, ethics.FanaticAuthoritarian),
    none(
  ...
  MediaConglomerate:          new Civic(() => none(
    civics.IdealisticFoundation,
  )),
  NavalContractors:           new Civic(() => every(
    some(ethics.Militarist, ethics.FanaticMilitarist),
    none(civics.CitizenService),
  )),
  PrivateMilitaryCompanies:   new Civic(() => every(
    some(ethics.Militarist, ethics.FanaticMilitarist),
    none(civics.WarriorCulture),
  )),
  RuthlessCompetition:        new Civic(() => none(
    civics.Meritocracy,
  )),
  CatalyticRecyclers:         new Civic(() => none(
    civics.CatalyticProcessing,
    origin.CalamitousBirth,
  )),
  MastercraftInc:             new Civic(() => none(
    civics.MasterfulCrafters,
  )),
  CorporateHedonism:          new Civic(() => none(
    civics.IndenturedAssets,
    civics.PleasureSeekers,
    civics.SlaverGuilds,
  )),
  PublicRelationsSpecialists: new Civic(() => none(
    civics.DiplomaticCorps,
  )),
  CorporateDeathCult:         new Civic(() => every(
    some(ethics.Spiritualist, ethics.FanaticSpiritualist),
    none(
      origin.Necrophage,
      civics.InwardPerfection,
  ...
  PermanentEmployment:        new Civic(() => none(
    ethics.Egalitarian, ethics.FanaticEgalitarian,
    origin.Mechanist,
    origin.CloneArmy,
    origin.Necrophage,
  )),
  CorporateAnglers:           new Civic(() => none(
    civics.AgrarianIdyll,
    origin.PostApocalyptic,
    origin.ShatteredRing,
    origin.VoidDwellers,
...
const civicsHive = {
  ...
  Empath:                  new Civic(() => none(
    civics.DevouringSwarm,
    civics.Terravore,
    origin.Necrophage,
  )),
  HiveMemorialist:         new Civic(() => none(
    civics.DevouringSwarm,
    civics.Terravore,
  )),
}
...
const civicsMachine = {
  ...
  DeterminedExterminator:     new Civic(() => none(
    civics.DrivenAssimilator,
    civics.RogueServitor,
  )),
  DrivenAssimilator:          new Civic(() => none(
    civics.DeterminedExterminator,
    civics.RogueServitor,
  )),
  RogueServitor:              new Civic(() => none(
    civics.DeterminedExterminator,
    civics.DrivenAssimilator,
    origin.ResourceConsolidation,
  )),
  MachineOrganicReprocessing: new Civic(() => none(
    origin.ResourceConsolidation,
  )),
  MachineMemorialist:         new Civic(() => none(
    civics.DeterminedExterminator,
    civics.DrivenAssimilator,
  )),
}
