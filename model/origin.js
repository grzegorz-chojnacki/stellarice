...
const origin = {
  ...
  OnTheShouldersOfGiants: () =>
    new Origin('On the Shoulders of Giants', () => none(
      ethics.Gestalt
    )),
  Scion: () =>
    new Origin('Scion', () => none(
      ethics.Gestalt,
      ethics.FanaticXenophobe,
      civics.PompousPurists,
    )),
  ShatteredRing: () =>
    new Origin('Shattered Ring', () => none(
      civics.Agrarian,
      civics.Anglers, civics.CorporateAnglers,
    )),
  VoidDwellers: () =>
    new Origin('Void Dwellers', () => none(
      ethics.Gestalt,
      civics.Agrarian,
      civics.Anglers, civics.CorporateAnglers,
  ...
  HereBeDragons: () =>
    new Origin('Here Be Dragons', () => none(
      civics.FanaticPurifiers,
      civics.DevouringSwarm,
      civics.MachineTerminator,
    )),
  OceanParadise: () =>
    new Origin('Ocean Paradise', () => none(
      authority.MachineIntelligence
    )),
  SlingshotToTheStars: () =>
    new Origin('Slingshot to the Stars'),
  ImperialFiefdom: () =>
    new Origin('Imperial Fiefdom', () => none(
      civics.InwardsPerfection,
  ...
  Subterranean: () =>
    new Origin('Subterranean', () => none(
      authority.MachineIntelligence
    )),
  TeachersOfTheShroud: () =>
    new Origin('Teachers of the Shroud', () => every(
      every(ethics.Spiritualist, ethics.FanaticSpiritualist),
      none(civics.FanaticPurifiers)
    )),
  ProgenitorHive: () =>
    new Origin('Progenitor Hive', () => none(
      authority.HiveMind
    )),
}
